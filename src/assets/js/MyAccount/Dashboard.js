export const dashboard = () => {
  ...
  document.querySelector('.dashboard__user-name').textContent =
    dashboardUser.nameInput;
  document.querySelector('.dashboard__user-name2').textContent =
    dashboardUser.nameInput;
  ...
  const targetDashboard = document.querySelector(
    '.myAccount__tabPage .targetOf-dashboard'
  );
  ...
  const btnBillingAddress = document.querySelector(
    '.dashboard__link-addresses'
  );
  ...
  btnAccountDetails.addEventListener('click', () => {
    const targetAccountDetails = document.querySelector(
      '.targetOf-accountDetails'
    );
